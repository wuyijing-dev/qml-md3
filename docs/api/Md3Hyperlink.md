...
- **Source:** `src/Md3/components/Md3Hyperlink.qml`
...
[`Md3Hyperlink`](Md3Hyperlink.md) → [`Md3AbstractButton`](Md3AbstractButton.md)

## Properties

| Name | Type | Default | Access | Defined in | Description |
|------|------|---------|--------|------------|-------------|
| `url` | `url` | `""` | read/write | `Md3Hyperlink` | Url. |
| `openExternally` | `bool` | `true` | read/write | `Md3Hyperlink` | When true and `url` is set, click calls Qt.openUrlExternally. |
| `underline` | `bool` | `true` | read/write | `Md3Hyperlink` | Underline. |
