...
[`Md3InputChip`](Md3InputChip.md) → [`Md3AbstractButton`](Md3AbstractButton.md)

## Properties

| Name | Type | Default | Access | Defined in | Description |
|------|------|---------|--------|------------|-------------|
| `avatarIcon` | `string` | `""` | read/write | `Md3InputChip` | Avatar Icon. |
...
|--------|------------|-------------|
| `removed()` | `Md3InputChip` | Emitted when removed. |
