...
- [Md3Gauge](Md3Gauge.md) — Open-arc KPI gauge (see also Ring / Needle / Segment / Dots / MultiRing / Half / Wave / TickRing).
...
- [Md3LiquidGlass](Md3LiquidGlass.md) — Experimental: draggable Liquid Glass (regional backdrop sample, not full-scene blur).
- [Md3LiquidGlassFusionPlayground](Md3LiquidGlassFusionPlayground.md) — Experimental: two-body SDF fusion playground for liquid glass merging.
