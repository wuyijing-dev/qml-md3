...
| `dropletB` | `vector4d` | `Qt.vector4d(0.5, 0.5, 0.0, 0.0)` | read/write | `Md3LiquidGlass` | — |
| `dropletC` | `vector4d` | `Qt.vector4d(0.5, 0.5, 0.0, 0.0)` | read/write | `Md3LiquidGlass` | — |
...
| `layoutMode` | `int` | `Md3ContainerBody.Fit` | read/write | `Md3LiquidGlass` | — |
| `contentData` | `alias` | `contentHost.content` | default read/write | `Md3LiquidGlass` | Default property → `contentHost.content` |
