...
| `language` | `string` | `"qml" // qml \| js \| javascript \| cpp \| c++ \| json \| plain` | read/write | `Md3CodeBlock` | — |
...
| `_lang` | `string` | `{…}` | readonly | `Md3CodeBlock` | — |
| `_html` | `string` | `""` | read/write | `Md3CodeBlock` | — |
| `_gen` | `int` | `0` | read/write | `Md3CodeBlock` | — |
...
Md3CodeBlock {
    code: ""
    language: "qml" // qml | js | javascript | cpp | c++ | json | plain
