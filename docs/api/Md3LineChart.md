...
Line / area chart — QtQuick.Shapes. Extends Md3Chart. Supports X zoom/pan (`interactive`) and nearest-point probe (`showProbe`).

- **Source:** `src/Md3/components/Md3LineChart.qml`
- **Extends:** `Md3Chart`
...
[`Md3LineChart`](Md3LineChart.md) → [`Md3Chart`](Md3Chart.md)

## Properties

| Name | Type | Default | Access | Defined in | Description |
|------|------|---------|--------|------------|-------------|
| `live` | `bool` | `false` | read/write | `Md3LineChart` | Live. |
| `livePointCount` | `int` | `48` | read/write | `Md3LineChart` | Live Point Count. |
| `liveSpeed` | `real` | `2.4` | read/write | `Md3LineChart` | Live Speed. |
| `livePhase` | `real` | `0` | read/write | `Md3LineChart` | Live Phase. |
...
|--------|---------|------------|-------------|
| `ensureLiveBuffer()` | `—` | `Md3LineChart` | Ensure Live Buffer. |
| `advanceLive(dt)` | `—` | `Md3LineChart` | Advance Live. |
| `rebuild()` | `—` | `Md3LineChart` | Rebuild. |
| `nudgeProbe(delta)` | `—` | `Md3LineChart` | Nudge Probe. |
