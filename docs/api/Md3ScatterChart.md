...
[`Md3ScatterChart`](Md3ScatterChart.md) → [`Md3Chart`](Md3Chart.md)

## Properties

| Name | Type | Default | Access | Defined in | Description |
|------|------|---------|--------|------------|-------------|
| `pointRadius` | `real` | `4` | read/write | `Md3ScatterChart` | Point Radius. |
| `xValues` | `var` | `[]` | read/write | `Md3ScatterChart` | Optional parallel X coordinates (default: 0..n-1). |
...
|--------|---------|------------|-------------|
| `rebuild()` | `—` | `Md3ScatterChart` | Rebuild. |
