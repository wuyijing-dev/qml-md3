...
| `model` | `var` | `[] // [{ text, icon?, enabled? }]` | read/write | `Md3ButtonGroup` | — |
| `enabled` | `bool` | `true` | read/write | `Md3ButtonGroup` | — |
| `currentIndex` | `int` | `-1 // optional highlight; -1 = none` | read/write | `Md3ButtonGroup` | — |
...
Md3ButtonGroup {
    ...
    currentIndex: -1 // optional highlight; -1 = none
    spacing: 8
}
```
