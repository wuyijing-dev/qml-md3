...
```powershell
python scripts/checks/check_a11y_qml.py --json docs/a11y-scan.json --strict
python scripts/checks/check_qstr_coverage.py --json docs/i18n-scan.json --strict
Copy-Item docs/a11y-scan.json gallery/data/a11y-scan.json
```
