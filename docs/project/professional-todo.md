...
11. [x] **Electron 对标宿主**：`Md3NativeShell` 单实例 / 开机启动 / 全局快捷键(Win) / 协议注册 / 电源锁屏 / `getPath`

## 壳层对照

| 状态 | 项 |
|------|----|
| 已有 | Rail / Drawer / Bar / Scaffold / NavigationView / **Flyout** / TitleBar 槽示例 / **NativeShell** |
| 后续 | CommandBar a11y 矩阵；真机 SafeArea（6.9+ feature gate）；Wayland GlobalShortcuts portal |
