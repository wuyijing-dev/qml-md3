...
/*
  Flutter-like progress: vsync FrameAnimation drives paint every frame
  (same idea as AnimationController + CustomPainter), not a 10fps Timer.
*/
Item {
    id: root
    ...
    Component.onCompleted: if (isWavy) Qt.callLater(function () { wave.requestPaint() })
}
