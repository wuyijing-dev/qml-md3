...
Status: **1.1.3** (IDE-shell usability + 1.1.2 desktop task chrome). Android / WASM remain experimental — see [docs/project/professional-todo.md](docs/project/professional-todo.md). Releases follow [docs/getting-started/release-checklist.md](docs/getting-started/release-checklist.md).
