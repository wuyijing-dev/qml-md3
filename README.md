...
Status: **1.1.3** (Windows-focused production tag; 1.1.1 host lock + desktop task chrome). Android / WASM remain experimental — see [docs/project/professional-todo.md](docs/project/professional-todo.md). Releases follow [docs/getting-started/release-checklist.md](docs/getting-started/release-checklist.md).
...
`1.1.3` — lock tag for product apps (see CHANGELOG). Pin `v1.1.3`, not floating `main`.
